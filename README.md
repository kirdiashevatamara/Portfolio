...
Привет! Меня зовут Тамара Кирдяшева, я начинающий аналитик данных, с опытом использования различных инструментов и технологий для сбора, организации и анализа данных. 
...
<p>Что нужно было сделать:<p> Сборка калькулятора юнит-экономики онлайн школы, с возможностью корректировки маркетингового плана. Прогнозирование нового плана найма преподавателей, на основе ретро-данных. Визуализация.
<ol>
